...
public class ImageLoader {
    ...
    public static ImageListener getImageListener(final ImageView view, final NetworkImageListener listener,
    		final int defaultImageResId, final int errorImageResId) {
    	return new ImageListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
            ...
            public void onResponse(ImageContainer response, boolean isImmediate) {
                if (response.getBitmap() != null) {                    
                    if(listener != null) {
                    	listener.onGetBitmapListener(view, response.getBitmap());
                    } else {
                    	view.setImageBitmap(response.getBitmap());
                    }
                } else if (defaultImageResId != 0) {
    ...
    public ImageContainer get(String requestUrl, final ImageListener listener,
        ...
        return get(requestUrl, listener, 0, 0, progressListener);
    }
     ...
     */    
    public ImageContainer get(String requestUrl, ImageListener imageListener,
            int maxWidth, int maxHeight, DownloadProgressListener progressListener) {
        ...
        if(progressListener != null) {
        	newRequest.setProgressListener(progressListener);
        }        
