...
public class NetworkImageView extends ImageView {
    ...
    public void setImageUrl(String url, ImageLoader imageLoader, DownloadProgressListener listener) {
        mUrl = url;
        mImageLoader = imageLoader;
                    ...
                    public void onResponse(final ImageContainer response, boolean isImmediate) {
                        ...
                        if (response.getBitmap() != null) {
                        	if(mListener == null) {
                        		...
                        		mListener.onGetBitmapListener(NetworkImageView.this, response.getBitmap());
                        	}
    ...
    public void setNetworkImageListener(NetworkImageListener listener) {
    	mListener = listener;
    }
}
