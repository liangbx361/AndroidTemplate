package com.common.tools.exception;
 ...
 * @描述：程序崩溃处理,存储异常信息
 * @作者：liang bao xian
 * @时间：2015年1月14日 上午10:14:28
 */
public class ExceptionLog implements UncaughtExceptionHandler {
	/**
	...
	/** CrashHandler实例 */
	private static ExceptionLog INSTANCE;
	...
	public void init(Context ctx) {
		...
		File logFile = FileDirUtil.getDiskCacheDir(ctx, "log");
		if(!logFile.exists()) {
			logFile.mkdirs();
		}
